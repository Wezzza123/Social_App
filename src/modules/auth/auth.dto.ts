...
export type IForgetPassword = z.infer<typeof validators.forgetPassword.body>

export type IResendForgetPasswordOTP = z.infer<typeof validators.forgetPassword.body>
