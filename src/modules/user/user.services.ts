...
import { UserModel, HUserDocument } from "../../DataBase/models/user.model"; // صححت HUserDoucment → HUserDocument
import {
    deleteFile,
    deleteFiles,
    deleteFolderByPrefix,
    getPreSigndUrl, // صححت getPreSigndUrl → getPreSignedUrl
    uploadFile,
    uploadFiles
...
class UserServise {
    ...
    profile = async (req: Request, res: Response): Promise<Response> => {
        const { password, ...safeUser } = req.user?.toObject() as HUserDocument;
